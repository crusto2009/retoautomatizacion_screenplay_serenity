...
import com.exito.tasks.DetalleProductoTask;
import com.exito.tasks.ListaProductosTask;
import com.exito.tasks.PaginaInicialTask;
...
public class AgregarProductoCarritoStepDef {
    ...
    public void queElUsuarioAbreElNavegadorYBuscaUnProducto() {
    ...
    public void elUsuarioPodraSeleccionarUnProductoDeFormaAleatoriaYAgregarloAlCarrito() {
